...
import { UpdateAdminData, clearAdminAndToken, useAdminSelector } from "../../reducers/adminReducer"
import AlertContext from "../../context/AlertContext"
import { useUpdateProfileMutation } from "../../reducers/adminSlice"
...
const AdminProfile = () => {
  ...
  const [inputs, setInputs] = useState(admin||{})
      ...
      <div className="container d-flex flex-column justify-content-center align-items-center my-2">
        <div className="shadow-lg rounded p-3">
          ...
          <div className="text-center float-start my-1">
            <Link className="text-decoration-none" to="/admin/changePassword">
              Change Password?
            </Link>
          </div>
        </div>
